...
export const getRunSQLQueryResponseMock = (overrideResponse = {}) => ({
...
export const getListTokensForAccountResponseMock = (overrideResponse = {}) => ({
    accountAddress: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
    tokenAddresses: faker.helpers.arrayElement([
        Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => faker.helpers.fromRegExp("^0x[0-9a-fA-F]{40}$")),
        undefined,
    ]),
    totalCount: faker.helpers.arrayElement([faker.number.int({ min: 0, max: undefined }), undefined]),
    ...overrideResponse,
});
export const getListDataTokenBalancesResponseMock = () => ({
    ...{
...
export const getRunSQLQueryMockHandler = (overrideResponse) => {
    return http.post("*/v2/data/query/run", async (info) => {
        ...
        return new HttpResponse(JSON.stringify(overrideResponse !== undefined
            ? typeof overrideResponse === "function"
                ...
                : overrideResponse
            : getRunSQLQueryResponseMock()), { status: 200, headers: { "Content-Type": "application/json" } });
    });
};
export const getListTokensForAccountMockHandler = (overrideResponse) => {
    return http.get("*/v2/data/evm/token-ownership/:network/:address", async (info) => {
        ...
        return new HttpResponse(JSON.stringify(overrideResponse !== undefined
            ? typeof overrideResponse === "function"
                ? await overrideResponse(info)
                : overrideResponse
            : getListTokensForAccountResponseMock()), { status: 200, headers: { "Content-Type": "application/json" } });
    });
};
export const getListDataTokenBalancesMockHandler = (overrideResponse) => {
    return http.get("*/v2/data/evm/token-balances/:network/:address", async (info) => {
        ...
        return new HttpResponse(JSON.stringify(overrideResponse !== undefined
            ? typeof overrideResponse === "function"
                ? await overrideResponse(info)
                : overrideResponse
            : getListDataTokenBalancesResponseMock()), { status: 200, headers: { "Content-Type": "application/json" } });
    });
};
