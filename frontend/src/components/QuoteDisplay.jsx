      ...
      <div className="quote-header">
        ...
        <div className="quote-details">
          <div className="quote-row">
            ...
            <span className="amount">{formatCOP(parseFloat(quote.monto_cop))}</span>
          </div>
          ...
          <div className="quote-row">
            ...
            <span className="fees">{formatCOP(parseFloat(quote.fee_transaccion))}</span>
          </div>
          
          <div className="quote-row">
            <span>Fee de red:</span>
            <span className="fees">{formatCOP(parseFloat(quote.fee_red))}</span>
          </div>
          
          <div className="quote-row total-row">
            <span>Total fees:</span>
            <span className="total-fees">{formatCOP(parseFloat(quote.total_fees))}</span>
          </div>
          ...
          <div className="quote-row">
            ...
            <span className="swap-fee">{formatCOP(parseFloat(quote.swapFee))}</span>
          </div>
